    ...
    <div class="align-self-center login">
        ...
        <form class="mb-3" method="POST" action="{{ route('login.auth') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control border-0 p-0" id="dni" name="dni" required
                       pattern="^[0-9]{8}[A-Z]$">
            </div>
            @isset($error)
                <div class="mb-3">
                    <label for="password" class="form-label text-primary fw-bold">Contraseña</label>
                    <input type="password" class="form-control border-0 p-0" id="password" name="password" required
                           minlength="8">
                </div>
