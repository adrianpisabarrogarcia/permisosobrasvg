        ...
        <div class="container flex-column align-items-center justify-content-center mt-5">
            ...
            <div>
                <div class="card border-0 bg-transparent">
                    <span>En caso de tener alguna duda sobre el funcionamiento de nuestra web o de la metodología de la empresa contacta con nosotros</span>
                    <span>Rellena el formulario que se mostrará a continuación:</span>
            ...
            <div class=" h-25 w-75 m-auto pb-5 ">
                <form action="{{}}" method="post" class="d-flex flex-column align-items-center border-4">
                    ...
                    <label for="mensaje" ><h3 class="font-weight-normal text-dark">Correo electronico</h3></label>
                    <textarea  id="mensaje" required class="w-75 overflow-hidden"rows="7"></textarea><br>
                    <button class="rounded bg-pistacho border-pistacho p-3">Enviar mensaje</button>
