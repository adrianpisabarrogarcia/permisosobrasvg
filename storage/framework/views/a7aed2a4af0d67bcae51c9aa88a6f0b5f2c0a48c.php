...
<!-- solucionar la ruta -->
<a class="nav-link enlace" href="<?php echo e(route('comprobarSolicitudes')); ?>">
    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt text-primary"></i></div>
    Comprobar Solicitudes
</a>
<a class="nav-link enlace" href="<?php echo e(route('solicitudesSinAsignar')); ?>">
    <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt text-primary"></i></div>
    Asignar Solicitudes
</a>
<div class="sb-sidenav-menu-heading bg-primary text-light pt-3">Datos</div>
<a class="nav-link enlace" href="<?php echo e(route('portal.graficos')); ?>">
    <div class="sb-nav-link-icon"><i class="fas fa-chart-bar text-primary"></i></div>
    Estadísticas
</a>
<a class="nav-link enlace" href="<?php echo e(route('annadirObraEdificio')); ?>">
...
<a class="nav-link enlace" href="<?php echo e(route('creacionUsuarios')); ?>">
...
<a class="nav-link enlace" href="<?php echo e(route('listarUsuarios')); ?>">
    <div class="sb-nav-link-icon"><i class="fas fa-users text-primary"></i></div>
    Empleados y Usuarios
</a>
<?php /**PATH /home/vagrant/code/permisosobrasvg/resources/views/principal/coordinador/menuCoordinador.blade.php ENDPATH**/ ?>