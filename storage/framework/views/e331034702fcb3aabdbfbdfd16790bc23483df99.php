...
<body>
    <section class="row g-0">
        <div class="col-lg-6 col-md-6 d-flex flex-column justify-content-center align-items-center vh-100 min-vh-100">
            <?php echo $__env->yieldContent('contenidologin'); ?>
        </div>
...
<?php /**PATH /home/vagrant/code/permisosobrasvg/resources/views/login/layouts/layoutlogincarrousel.blade.php ENDPATH**/ ?>