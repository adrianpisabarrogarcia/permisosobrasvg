        ...
        <div class="container-fluid row justify-content-between py-5 w-100">
            ...
            <?php switch(Session::get('rol')):
                ...
                <div class="col-12 col-lg-6 h-auto row mt-3 ml-4 ml-lg-0 pl-5 float-end align-items-center justify-content-around">
                    ...
                    <a href="<?php echo e(route('portal.graficos')); ?>" class="h-25 text-white enlaceprin col-4 col-md-4 col-lg-5 py-4 mr-5 border-2 rounded border-transparent text-dark d-flex align-items-center justify-content-center text-decoration-none text-center">Gráficos</a>
                </div>
                <?php break; ?>
                <?php case ('2'): ?>
                <div class="col-12 col-lg-6 h-auto row mt-3 ml-4 ml-lg-0 pl-5 float-end align-items-center justify-content-around">
                    ...
                    <a href=" <?php echo e(route('comprobarSolicitudes')); ?>" class="h-25 text-white enlaceprin col-4 col-md-4 col-lg-5 py-4 mr-5 border-2 rounded border-transparent text-dark d-flex align-items-center justify-content-center text-decoration-none text-center">Comprobar Solicitudes</a>
                </div>
                <?php break; ?>
                <?php default: ?>
                <div class="col-12 col-lg-6 h-auto row mt-3 ml-4 ml-lg-0 pl-5 float-end align-items-center justify-content-around">
                    ...
                    <a href="<?php echo e(route('contacto')); ?>" class="h-25 text-white enlaceprin col-4 col-md-4 col-lg-5 py-4 mr-5 border-2 rounded border-transparent d-flex align-items-center text-dark justify-content-center text-decoration-none text-center">Contacto</a>
                </div>
                <?php break; ?>
            <?php endswitch; ?>
        </div>
