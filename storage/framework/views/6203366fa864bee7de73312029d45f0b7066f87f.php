<?php $__env->startSection('titulo','Ayuntamiento de Vitoria | Registro'); ?>
    ...
    <?php $__env->startSection('contenidologin'); ?>
        <div class="align-self-center login">
            ...
            <div class="text-center px-lg-5 pb-lg-2 p-2 w-100">
                <a href="<?php echo e(route('login.home')); ?>" class="text-primary fw-bold text-decoration-none">Volver al inicio</a>
            </div>
        </div>
...
<?php echo $__env->make('login.layouts.layoutlogincarrousel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/permisosobrasvg/resources/views/login/registro.blade.php ENDPATH**/ ?>