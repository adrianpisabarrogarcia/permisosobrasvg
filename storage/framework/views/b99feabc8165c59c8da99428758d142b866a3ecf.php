            ...
            <div class="col-12 col-lg-8 mx-auto">
                <div class="datos bg-primary w-100" style="border-radius: 0 0 calc(0.25rem - 1px) calc(0.25rem - 1px)">
                    ...
                    <div class="card-footer datosusu pb-1 ps-0 pe-0 pt-0 container mb-4 card shadow">
                        <form id="form-contra" method="post" action="<?php echo e(route("cambiarContra")); ?>">
                            <?php echo csrf_field(); ?>
                        ...
                        <form id="datos" method="post" action="<?php echo e(route("modificarPerfil")); ?>">
                            <?php echo csrf_field(); ?>
                            <div class="card-body row">
                                <!-- datos-->
                                <div class="col-12 col-xl-6 d-flex flex-column align-items-center">
                                        <label><h5 class="mb-0 text-dark">Nombre:</h5></label>
                                        <input type="text" name="nombre" class="mod text-center border-1 col-lg-9 card-footer contacto p-1 rounded" value="<?php echo e($usuario[0]->nombre); ?>" disabled pattern="^([A-Za-zÀ-ÿ]+[ ]?)+$">
                                        <label class="mt-2"><h5 class="mb-0 text-dark rounded">Apellido:</h5></label>
                                        <input type="text" name="apellido" class="mod text-center border-1 col-lg-9 card-footer contacto p-1 rounded" value="<?php echo e($usuario[0]->apellido); ?>" disabled pattern="^([A-Za-zÀ-ÿ]+[ ]?)+$">
                                        <label class="mt-2"><h5 class="mb-0 text-dark rounded">Teléfono:</h5></label>
                                        <input type="text" name="telefono" class="mod text-center border-1 col-lg-9 card-footer contacto p-1 rounded" value="<?php echo e($usuario[0]->telefono); ?>" pattern="^[9|8|7|6]\d{8}$" disabled>
                                        <label class="mt-2"><h5 class="mb-0 text-dark">Email:</h5></label>
                                        <input type="text" name="email" class="mod col-lg-9 text-center border-1 card-footer contacto p-1 rounded" value="<?php echo e($usuario[0]->email); ?>" pattern="[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$" disabled>
                                </div>
                                <div class="col-12 col-xl-6 d-flex flex-column align-items-center">
                                        <label><h5 class="mb-0 text-dark">Dirección:</h5></label>
                                        <input type="text" name="direccion" class="mod text-center border-1 col-lg-9 card-footer contacto p-1 rounded" value="<?php echo e($usuario[0]->calle); ?>" disabled pattern="^[A-Za-zÀ-ÿ]+([A-Za-zÀ-ÿ]*[ ]?[-]?[0-9]*[º]?[ª]?[,]?)+$">
                                        <label class="mt-2"><h5 class="mb-0 text-dark">CP:</h5></label>
                                        <input type="text" name="cp" class="mod col-lg-9 text-center border-1 card-footer contacto p-1 rounded" value="<?php echo e($usuario[0]->codigo_postal); ?>" pattern="^(?:0[1-9]|[1-4]\d|5[0-2])\d{3}$" disabled>
                                        <label class="mt-2"><h5 class="mb-0 text-dark">Provincia:</h5></label>
                                        <input type="text" name="provincia" class="mod col-lg-9 text-center border-1 card-footer contacto p-1 rounded" value="<?php echo e($usuario[0]->provincia); ?>" pattern="^([A-Za-zÀ-ÿ]+[ ]?[-]?[/]?)+$" disabled>
                                        <label class="mt-2"><h5 class="mb-0 text-dark">Municipio:</h5></label>
                                        <input type="text" name="municipio" class="mod col-lg-9 text-center border-1 card-footer contacto p-1 rounded" value="<?php echo e($usuario[0]->municipio); ?>" pattern="^([A-Za-zÀ-ÿ]+[ ]?[-]?[/]?)+$" disabled>
                                        <input type="hidden" name="dni" value="<?php echo e($usuario[0]->dni); ?>">
                                </div>
                                <?php if(isset($error)): ?>
...
<?php echo $__env->make("principal.layouts.estructuraPagina", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/permisosobrasvg/resources/views/principal/perfil.blade.php ENDPATH**/ ?>