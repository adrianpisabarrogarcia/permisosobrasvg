            ...
            <div class=" card-body row my-3">
                ...
                <div class=" col-12 col-xl-6 d-flex flex-column align-items-center mt-3">
                    <div class="">
                        ...
                        <input type="text"  class=" mod" value="<?php echo e($usuario[0]->nombre); ?>" disabled>
                    </div>
                    <div>
                        <label class="ml-1 mr-5"><h5>Apellido</h5></label>
                        <input type="text" class="mod" value="<?php echo e($usuario[0]->apellido); ?>" disabled>
                    </div>
                </div>
                <div class=" col-12 col-xl-6 d-flex flex-column align-items-center mt-3">
                    <div>
                        <label class=" mr-5 "><h5 class="">DNI</h5></label>
                        <input type="text" value="<?php echo e($usuario[0]->dni); ?>" disabled>
                    </div>
                    <div>
                        <label class="ml-3 mr-5"><h5 class="ml-4 ">Email</h5></label>
                        <input type="text" class=" mod mr-5" value="<?php echo e($usuario[0]->email); ?>" disabled>
                    </div>
                </div>
